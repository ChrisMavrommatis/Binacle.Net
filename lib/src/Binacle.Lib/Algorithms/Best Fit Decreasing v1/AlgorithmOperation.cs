...
internal partial class BestFitDecreasing_v1<TBin, TItem>
{
	public OperationResult Execute(IOperationParameters parameters)
	{
		...
		foreach (var item in orderedItems)
		{
			...
			{
				var availableSpaceQuadrant = FindBestAvailableSpace(item, availableSpace);
	...
	private static SpaceVolume? FindBestAvailableSpace(Item orientation, List<SpaceVolume> availableSpace)
	{
