...
internal sealed partial class WorstFitDecreasing_v3<TBin, TItem> : IFittingAlgorithm
	where TBin : class, IWithID, IWithReadOnlyDimensions
	where TItem : class, IWithID, IWithReadOnlyDimensions, IWithQuantity
{
	public AlgorithmInfo AlgorithmInfo => new(Algorithm.WorstFitDecreasing, "Worst Fit Decreasing", 3);
	...
	internal WorstFitDecreasing_v3(TBin bin, IList<TItem> items)
	{
		Guard.Against
			.Null(bin)
