...
internal sealed partial class BestFitDecreasing_v3<TBin, TItem> : IFittingAlgorithm
	where TBin : class, IWithID, IWithReadOnlyDimensions
	where TItem : class, IWithID, IWithReadOnlyDimensions, IWithQuantity
{
	public AlgorithmInfo AlgorithmInfo => new(Algorithm.BestFitDecreasing, "Best Fit Decreasing", 3);
	...
	internal BestFitDecreasing_v3(TBin bin, IList<TItem> items)
	{
		Guard.Against
			.Null(bin)
