...
internal class BadRequestErrorResponseExamples : MultipleSwaggerExamplesProvider<Response<List<IApiError>>>
{
	public override IEnumerable<ISwaggerExample<Response<List<IApiError>>>> GetExamples()
	{
