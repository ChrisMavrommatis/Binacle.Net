...
| `src/Binacle.Net.UIModule` | `UI_MODULE` | Blazor interactive packing demo |
...
|---|---|---|
| `test/Binacle.Net.IntegrationTests` | `just test api-core-integration` | HTTP tests for v3 and v4 endpoints |
