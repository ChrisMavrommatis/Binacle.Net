...
internal class PresetBin : IGroupedEndpoint<ApiV4EndpointGroup>
{
	public void DefineEndpoint(RouteGroupBuilder group)
	{
		group.MapPost("pack/bin/{preset}/{bin}", HandleAsync)
			...
			.Accepts<PackPresetBinRequest>(MediaTypeNames.Application.Json)
			.RequestExample<PackPresetBinRequestExample>(MediaTypeNames.Application.Json)
			...
			.ResponseExamples<PackPresetBinResponseExamples>(StatusCodes.Status200OK, MediaTypeNames.Application.Json)
