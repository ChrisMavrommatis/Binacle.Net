...
public class FitPresetCompareBehavior : BehaviourTestsBase
{
	...
	private readonly FitPresetCompareRequest sampleRequest = new()
	{
	...
	public FitPresetCompareBehavior(BinacleApi sut) : base(sut)
	{
	}
	...
	public Task Post_ReturnsOneResultPerPresetBin()
		=> base.FitCompareRequest_Validate(UrlFor(PresetKeys.CustomProblems), this.sampleRequest, result =>
	...
	public async Task Post_WithAlgorithmFFD_ReturnsAlgorithmUsedFFD()
	{
		...
		await base.FitCompareRequest_Validate(UrlFor(PresetKeys.CustomProblems), request, result =>
		{
