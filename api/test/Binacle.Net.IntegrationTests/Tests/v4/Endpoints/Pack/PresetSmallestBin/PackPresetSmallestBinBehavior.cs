...
public class PackPresetSmallestBinBehavior : BehaviourTestsBase
{
	...
	private readonly PackPresetSmallestBinRequest sampleRequest = new()
	{
	...
	public PackPresetSmallestBinBehavior(BinacleApi sut) : base(sut)
	{
	}
	...
	// A 1x1x1 item packs into every bin in the preset, so the least roomy one has to win outright.
	[Fact(DisplayName = $"POST {routePath}. Returns The Smallest Bin That Packs All Items")]
