...
namespace Binacle.Net.IntegrationTests.v4.Endpoints.Pack.CustomSmallestBin;

[Trait("Behavioral Tests", "Ensures operations behave as expected")]
public class PackCustomSmallestBinBehavior : BehaviourTestsBase
{
	...
	public PackCustomSmallestBinBehavior(BinacleApi sut) : base(sut)
	{
	}
