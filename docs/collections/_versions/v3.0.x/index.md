...
> The documentation for this version is being written. Until it is ready, see the
> [previous version]({{ '/version/v2.1.x/' | relative_url }}) — note that API v2 has been removed in this
> version and API v4 added.
{: .block-warning}
