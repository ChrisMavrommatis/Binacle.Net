...
Version 4 covers everything Version 3 does, over 16 endpoints, and organises them by the answer you want
...
The response's `algorithmUsed` says which heuristic produced the result you got, so `Best` never leaves you
guessing.
