...
`CuratedScenarioProvider`. The reverted shared-`TestFiles` attempt and why it failed is [decisions.md](../../docs/vipaq/decisions.md)
...
- **Synthetic is still a stub.** `SyntheticDataProvider` returns nothing. Rebuild it **CPU/memory only**, scaling to
  item counts no real pack reaches (2000, 5000) — see [decisions.md](../../docs/vipaq/decisions.md) D9 — and **only then** add a
...
[README.md](README.md) · [decisions.md](../../docs/vipaq/decisions.md) (D9 synthetic scope, D10 no shared TestFiles).
