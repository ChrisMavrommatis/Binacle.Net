...
`results/vipaq/SizeComparison.md`. Numbers live in `.agents/docs/vipaq/findings.md`.
...
- `.agents/docs/vipaq/findings.md` (the numbers), `.agents/plans/vipaq/codec-race.md` (the harness report)
