...
public class PackByPresetBehavior :  Abstractions.BehaviourTestsBase
{
	...
	private readonly Api.v2.Requests.PresetPackRequest sampleRequest = new()
	{
		Parameters = new()
		{
	...
	private Api.v2.Requests.PresetPackRequest CreateSpecialRequest(
		Action<Api.v2.Requests.PackRequestParameters>? configure = null
		)
	{
