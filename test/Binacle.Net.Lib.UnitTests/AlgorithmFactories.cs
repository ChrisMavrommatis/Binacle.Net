...
internal static class AlgorithmFactories
{
	...
	public static Func<TestBin, IEnumerable<TestItem>, IFittingAlgorithm> Fitting_FFD_v3 = (bin, items)
		=> new Binacle.Net.Lib.Fitting.Algorithms.FirstFitDecreasing_v3<TestBin, TestItem>(bin, items.ToList());

	public static Func<TestBin, IEnumerable<TestItem>, IFittingAlgorithm> Fitting_FFD_v4 = (bin, items)
		=> new Binacle.Net.Lib.Fitting.Algorithms.FirstFitDecreasing_v4<TestBin, TestItem>(bin, items.ToList());
