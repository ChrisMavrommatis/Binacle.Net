...
public class ScalingBenchmarksCaseTests : IClassFixture<CommonTestingFixture>
{
	...
	[Theory]
	[ClassData(typeof(BenchmarkScalingTestsDataProvider))]
	public void Fitting_FFD_v3(BenchmarkScalingScenario scenario)
		=> this.RunFittingScenarioTest(AlgorithmFactories.Fitting_FFD_v3, scenario);


	[Theory]
	[ClassData(typeof(BenchmarkScalingTestsDataProvider))]
	public void Fitting_FFD_v4(BenchmarkScalingScenario scenario)
	...
	[Theory]
	[ClassData(typeof(BenchmarkScalingTestsDataProvider))]
	public void Packing_FFD_v3(BenchmarkScalingScenario scenario)
		=> this.RunPackingScenarioTest(AlgorithmFactories.Packing_FFD_v3, scenario);

	[Theory]
	[ClassData(typeof(BenchmarkScalingTestsDataProvider))]
	public void Packing_FFD_v4(BenchmarkScalingScenario scenario)
