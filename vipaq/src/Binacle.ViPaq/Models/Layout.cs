...
// one the encoder used, and a decoder obeys it. Public because a caller picks it through
// `ViPaqSerializationOptions`; everything else about the header stays internal.
public enum Layout
{
