...
// The ViPaq wire format's value limits (PROTOCOL.md §5).
public static class Limits
{
	// The largest value an Eight-width field holds (2^8 - 1).
	public const int EightBitsMax = 255;

	// Every dimension and coordinate is in [0, MaxValue] (2^16 - 1). No wider width, no saturation: encoding a
	// value above this is an error.
