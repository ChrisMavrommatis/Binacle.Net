...
// may be zero (an item at the origin), unlike dimensions. A value above the 16-bit ceiling is rejected. Names
// the offending axis so the message matches C#'s per-field ParamName.
