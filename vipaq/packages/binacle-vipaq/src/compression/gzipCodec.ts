...
// mtime, OS byte and a CRC trailer. That wrapper buys nothing here, so deflate is the pick; gzip is kept so it
// can be raced against raw DEFLATE, mirroring C#. CompressionStream('gzip') pairs with C#'s GZipStream.
