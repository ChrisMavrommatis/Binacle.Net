...
// codec: Compressed = 1 must carry a real compressed stream (PROTOCOL.md §6). It makes ProtocolEncoder testable
// - set the compressed bit, hand it this codec, and the compressed path runs with the body readable byte for
// byte.
