...
two implementations of the same wire format — a C# library (the reference implementation) and a hand-maintained
TypeScript mirror.
...
| `src/Binacle.ViPaq/` | C# library — the reference implementation |
