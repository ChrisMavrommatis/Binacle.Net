...
// Reads the shared interop inputs, serializes each with the C# ViPaq library, and writes the bytes
// (base64) to artifact-cs.json. Run by hand when the input scenarios change — the output is committed
// and read by BOTH test suites (see vipaq/test-vectors/interop/ and the cross-language plan).
...
var writeOptions = new JsonSerializerOptions
{
	...
	IndentCharacter = '\t',
	IndentSize = 1,
	// Keep base64 '+' and '/' literal instead of + escapes — the content is plain base64, so this
